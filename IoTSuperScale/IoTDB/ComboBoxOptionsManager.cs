...
namespace IoTSuperScale.IoTDB
{
    public class ComboBoxOptionsManager
    {
        ...
        private static List<PackagedMaterialItem> getPackagedMaterialItems()
        {
            ...
            items.Add(new PackagedMaterialItem() { code = "011", displayCodeDescr = "011 - ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΜΕΤΑΛΛΙΝΚΟ ΣΤΑΝΤ", materialDescr = "ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΜΕΤΑΛΛΙΝΚΟ ΣΤΑΝΤ", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΜΕΤΑΛΛΙΝΚΟ ΣΤΑΝΤ", country = "ΚΥΠΡΟΣ", region = "ΠΑΦΟΣ", recipe = PackagedMaterialItem.recipeType.RECIPESIMPLE, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 6.5, tarePrecentage = 0.07, isEEcountry = true, category = "II", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "011", displayCodeDescr = "011 - ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΜΕΤΑΛΛΙΝΚΟ ΣΤΑΝΤ-(7,5kg ΑΠΟΒΑΡΟ)", materialDescr = "ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΜΕΤΑΛΛΙΝΚΟ ΣΤΑΝΤ-(7,5kg ΑΠΟΒΑΡΟ)", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΜΕΤΑΛΛΙΝΚΟ ΣΤΑΝΤ", country = "ΚΥΠΡΟΣ", region = "ΠΑΦΟΣ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 7.5, tarePrecentage = 0, isEEcountry = true, category = "II", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "011", displayCodeDescr = "011 - ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΞΥΛΙΝΟ ΣΤΑΝΤ", materialDescr = "ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΞΥΛΙΝΟ ΣΤΑΝΤ", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΚΥΠΡΟΥ ΣΕ ΞΥΛΙΝΟ ΣΤΑΝΤ", country = "ΚΥΠΡΟΣ", region = "ΠΑΦΟΣ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 8, tarePrecentage = 0, isEEcountry = true, category = "II", variety = "Cavendish" });
            //future codes
            ...
            //imported products
            items.Add(new PackagedMaterialItem() { code = "001", displayCodeDescr = "001 - DOLE", materialDescr = "DOLE", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ DOLE", country = "ΕΚΟΥΑΔΟΡ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "002", displayCodeDescr = "002 - DELORO", materialDescr = "DELORO", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ DELORO", country = "ΕΚΟΥΑΔΟΡ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            ...
            items.Add(new PackagedMaterialItem() { code = "006", displayCodeDescr = "006 - CABANA", materialDescr = "CABANA", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ CABANA", country = "ΕΚΟΥΑΔΟΡ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "007", displayCodeDescr = "007 - BAJELA", materialDescr = "BAJELA", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ BAJELA", country = "ΕΚΟΥΑΔΟΡ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "009", displayCodeDescr = "009 - SIMBA", materialDescr = "SIMBA", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ SIMBA", country = "ΚΟΛΟΜΒΙΑ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "012", displayCodeDescr = "012 - FLESTA", materialDescr = "FLESTA", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ FLESTA", country = "ΕΚΟΥΑΔΟΡ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "014", displayCodeDescr = "014 - ORSERO", materialDescr = "ORSERO", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ ORSERO", country = "ΕΚΟΥΑΔΟΡ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            items.Add(new PackagedMaterialItem() { code = "015", displayCodeDescr = "015 - TROPY", materialDescr = "TROPY", materialReadableDescr = "ΜΠΑΝΑΝΕΣ ΕΙΣΑΓΩΓΗΣ TROPY", country = "ΚΟΛΟΜΒΙΑ", region = "ΚΕΝ. ΑΜΕΡΙΚΗ", recipe = null, type = PackagedMaterialItem.materialType.CONVENTIONAL, isEnabled = true, tarePack = 1.5, tarePrecentage = 0, isEEcountry = false, category = "Extra", variety = "Cavendish" });
            //other products
